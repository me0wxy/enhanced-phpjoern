...
public class PHPCSVNodeTypes
{
	...
	public static final String TYPE_NULLABLE_TYPE = "AST_NULLABLE_TYPE";
	...
	// version 70 replace TYPE_CLASS_CONST (version 30)
	...
	public static final String TYPE_PROP_GROUP = "AST_PROP_GROUP";
	...
	public static final String TYPE_ARROW_FUNC = "AST_ARROW_FUNC";

	/**
	 * ast.so 80 AST_*
	 */
	public static final String TYPE_TYPE_UNION = "AST_TYPE_UNION";
	public static final String TYPE_ATTRIBUTE_LIST = "AST_ATTRIBUTE_LIST";
	public static final String TYPE_ATTRIBUTE_GROUP = "AST_ATTRIBUTE_GROUP";
	public static final String TYPE_ATTRIBUTE = "AST_ATTRIBUTE";
	public static final String TYPE_NAMED_ARG = "AST_NAMED_ARG";
	public static final String TYPE_MATCH = "AST_MATCH";
	public static final String TYPE_MATCH_ARM_LIST = "AST_MATCH_ARM_LIST";
	public static final String TYPE_MATCH_ARM = "AST_MATCH_ARM";
	public static final String TYPE_CLASS_CONST_GROUP = "AST_CLASS_CONST_GROUP";
	public static final String TYPE_NULLSAFE_METHOD_CALL = "AST_NULLSAFE_METHOD_CALL";
	public static final String TYPE_NULLSAFE_PROP = "AST_NULLSAFE_PROP";
