...
public class FunctionDef extends FunctionDefBase
{
	...
	protected StringExpression functionName = null;
	protected StringExpression functionDocComment = null;
	protected AttributeList attributeList = null;
	protected IntegerExpression offset = null;
	...
	public StringExpression getFunctionName()
	{
	...
	public StringExpression getFunctionDocComment()
	{
		return this.functionDocComment;
	}
