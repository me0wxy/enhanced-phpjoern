...
public class PHPCFGFactory extends CFGFactory {
	...
	// mxy:
	public static CFG newInstance(ConditionalExpression conditionalExpression){
		try{
			CFG	CondCFGBlock = new CFG();
			CFGNode conditionContainer = new ASTNodeContainer(conditionalExpression.getCondition());
	...
	public static CFG newInstance(CoalesceExpression coalesceExpression){
		try{
			CFG	CoaleseCFG = new CFG();
			CFGNode leftExpression = new ASTNodeContainer(coalesceExpression.getLeft());
			CoaleseCFG.addVertex(leftExpression);
			CoaleseCFG.addEdge(CoaleseCFG.getEntryNode(),leftExpression);
			CoaleseCFG.addEdge(leftExpression,CoaleseCFG.getExitNode(),CFGEdge.TRUE_LABEL);

			CFGNode rightExpression = new ASTNodeContainer(coalesceExpression.getRight());
			CoaleseCFG.addVertex(rightExpression);
			CoaleseCFG.addEdge(leftExpression,rightExpression,CFGEdge.FALSE_LABEL);
			CoaleseCFG.addEdge(rightExpression,CoaleseCFG.getExitNode());
