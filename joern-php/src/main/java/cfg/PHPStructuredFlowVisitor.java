...
public class PHPStructuredFlowVisitor extends StructuredFlowVisitor  {
	...
	// mxy:
	@Override
	public void visit(ConditionalExpression expression) { returnCFG = PHPCFGFactory.newInstance(expression); }
	@Override
	public void visit(CoalesceExpression expression) { returnCFG = PHPCFGFactory.newInstance(expression); }
}
